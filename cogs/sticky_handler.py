...
import discord
from discord import CategoryChannel, DMChannel, ForumChannel, app_commands
...
class StickyHandler(commands.Cog):
    ...
    async def on_message(self, msg: discord.Message) -> None:
        ...
        assert isinstance(msg.channel, PartialMessageableChannel)
    ...
    async def unsubscribe_new_char_sticky(
        self, interaction: discord.Interaction, del_sticky: Optional[bool] = False
    ) -> None:
        ...
        """
        assert interaction.channel
        assert isinstance(interaction.channel, PartialMessageableChannel)
