...
class StickyHandler(commands.Cog):
    ...
    # command to create a new character sticky in a specific channel and
    # memory/storage (/new_char_sticky), should be locked to admin role
    ...
    async def new_char_sticky(self, interaction: discord.Interaction) -> None:
        ...
        if interaction.channel.id in CHARACTER_STICKIES:
            ...
            # if it doesn't exist, create a new sticky and add it to
            # memory/storage
    ...
    # command to remove a new character sticky in a specific channel and
    # memory/storage (/unsubscribe_new_char_sticky), should be locked to admin
    # role
